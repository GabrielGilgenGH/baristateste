...
export const clients: Client[] = [
  ...
  { name: 'ABEJ', initials: 'ABEJ', logoUrl: '/partners/hospital-dona-helena.svg' },
  { name: 'Armazém Cloud', initials: 'ARC', logoUrl: '/partners/armazem-cloud.svg' },
  { name: 'Ponta Negra Logística', initials: 'PAM', logoUrl: '/partners/pamplona.svg' },
