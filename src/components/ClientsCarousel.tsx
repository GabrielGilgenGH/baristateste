    ...
    <Card className="border border-[rgba(0,0,0,0.12)] bg-[#fdf5ea] p-6 shadow-lg">
      <div className="relative">
        ...
        <button
          ...
          className="absolute top-1/2 left-2 -translate-y-1/2 rounded-full bg-brand-cream/80 p-2 text-lg text-brand-espresso shadow focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-espresso hover:translate-x-0.5 z-20"
        >
          ‹
        </button>
        <button
          ...
          className="absolute top-1/2 right-2 -translate-y-1/2 rounded-full bg-brand-cream/80 p-2 text-lg text-brand-espresso shadow focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-espresso hover:-translate-x-0.5 z-20"
        >
          ›
        </button>
      </div>
