        ...
        {machines.map((machine) => (
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs uppercase tracking-[0.4em] text-brand-charcoal/75">
                {machine.capacity}
              </span>
            </div>
            <p className="text-sm text-brand-charcoal/90">Ideal para {machine.idealFor.toLowerCase()}.</p>
